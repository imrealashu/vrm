...
class ComposerStaticInit064130fa1d051bf8564bab8268c9674a
{
    ...
    public static $classMap = array (
        ...
        'Listbees\\VRM\\Commands\\InstallVRM' => __DIR__ . '/../..' . '/src/Commands/InstallVRM.php',
        'Listbees\\VRM\\Http\\Controllers\\AccountController' => __DIR__ . '/../..' . '/src/Http/Controllers/AccountController.php',
        'Listbees\\VRM\\Http\\Controllers\\HomeController' => __DIR__ . '/../..' . '/src/Http/Controllers/HomeController.php',
        'Listbees\\VRM\\Http\\Middleware\\VRMAuth' => __DIR__ . '/../..' . '/src/Http/Middleware/VRMAuth.php',
        'Listbees\\VRM\\Http\\Requests\\AddRouteRequest' => __DIR__ . '/../..' . '/src/Http/Request/AddRouteRequest.php',
        'Listbees\\VRM\\Providers\\VisualRouteManagerServiceProvider' => __DIR__ . '/../..' . '/src/providers/VisualRouteManagerServiceProvider.php',
        'Listbees\\VRM\\VrmControllers' => __DIR__ . '/../..' . '/src/VrmControllers.php',
        'Listbees\\VRM\\VrmMiddlewares' => __DIR__ . '/../..' . '/src/VrmMiddlewares.php',
        'Listbees\\VRM\\VrmMiddlewaresGroup' => __DIR__ . '/../..' . '/src/VrmMiddlewaresGroup.php',
        'Listbees\\VRM\\VrmPrefixes' => __DIR__ . '/../..' . '/src/VrmPrefixes.php',
        'Listbees\\VRM\\VrmRoutes' => __DIR__ . '/../..' . '/src/VrmRoutes.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit064130fa1d051bf8564bab8268c9674a::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit064130fa1d051bf8564bab8268c9674a::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit064130fa1d051bf8564bab8268c9674a::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit064130fa1d051bf8564bab8268c9674a::$classMap;
